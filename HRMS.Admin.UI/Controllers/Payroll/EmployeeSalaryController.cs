...
namespace HRMS.Admin.UI.Controllers.Payroll
{
    ...
    public class EmployeeSalaryController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                string template = $"Controller name {nameof(EmployeeSalaryController)} action name {nameof(Index)} exception is {ex.Message}";
        ...
        public async Task<IActionResult> DownloadExcelFormat()
        {
            ...
            {
                string template = $"Controller name {nameof(EmployeeSalaryController)} action name {nameof(DownloadExcelFormat)} exception is {ex.Message}";
                Serilog.Log.Error(ex, template);
                return RedirectToAction("Error", "Home");
            }
        }
        ...
        public async Task<IActionResult> UploadEmployeeSalary(UploadExcelVm model)
        {
            ...
            {
                string template = $"Controller name {nameof(EmployeeSalaryController)} action name {nameof(UploadEmployeeSalary)} exception is {ex.Message}";
                Serilog.Log.Error(ex, template);
                return RedirectToAction("Error", "Home");
            }
        }
        ...
        public async Task<IActionResult> CreateUserCredential(List<EmployeeDetail> responseData)
        {
            ...
            {
                string template = $"Controller name {nameof(EmployeeSalaryController)} action name {nameof(CreateUserCredential)} exception is {ex.Message}";
                Serilog.Log.Error(ex, template);
                return RedirectToAction("Error", "Home");
            }
        }
